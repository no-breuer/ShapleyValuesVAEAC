...
if __name__ == '__main__':
    ...
    data_x = np.load("data/datasets/seed_0/intervention/polynomial_latent_scm_dense_poly_degree_2_data_dim_10_latent_dim_4/train_x.npy")
    data_z = np.load("data/datasets/seed_0/intervention/polynomial_latent_scm_dense_poly_degree_2_data_dim_10_latent_dim_4/train_z.npy")
    ...
    results = ComputeImputations.train_VAEAC_model(data_x, distribution, param_now, path_to_save_model,
                                                   one_hot_max_sizes, A, relevant_latents, latent_dim=data_z.shape[1], batch_size=8)
